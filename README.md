...
4. [Запрос 3. Получение списка телефонов сотрудников заданной должности в одном из отделов](запрос-3-получение-списка-телефонов-сотрудников-заданной-должности-в-одном-из-отделов)
...
```
## Запрос 3. Получение списка телефонов сотрудников заданной должности в одном из отделов
Запрос (функция) выглядит следующим образом:
```
